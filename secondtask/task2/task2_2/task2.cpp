...
// Глобальный sink: сюда записываем результат,
// чтобы компилятор не удалял вычисления как "ненужные"
...
// OpenMP версия: локальная сумма + atomic
...
// Среднее с отбрасыванием максимума
